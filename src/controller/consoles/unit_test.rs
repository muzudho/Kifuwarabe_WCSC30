...
pub fn test(line: &String, starts: &mut usize, len: usize, universe: &mut Universe) {
    ...
    if 4 < (len - *starts) && &line[*starts..*starts + 5] == "mvsrc" {
        ...
        *starts += 1;
        ...
        universe.get_dialogue_part_mut().push_command( &"position startpos moves 6i5h 8c8d 9i9h 8d8e 3g3f 8e8f 5h4h 8f8g+ 1i1h 8g9h 2g2f 9h8h 9g9f 8h7i 2i3g 8b8i+ 2f2e 7i7h".to_string() );
        universe
            .get_dialogue_part_mut()
            .push_command(&"position1".to_string());
