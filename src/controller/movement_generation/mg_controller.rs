...
pub fn get_movement_by_square_and_piece_on_board<F1>(
    ...
    F1: FnMut(u64),
{
    assert_in_board(sq_dst.address, "Ｉnsert_ss_by_ms_km_on_banjo");
    ...
    for sq_src in &mv_src_hashset {
        assert_in_board(sq_src.address, "Ｉnsert_ss_by_ms_km_on_banjo ms_src(成り)");
...
pub fn get_movement_by_square_and_piece_on_drop<F1>(
    ...
    F1: FnMut(u64),
{
    assert_in_board(sq_dst.address, "get_movement_by_square_and_piece_on_drop");
    ...
    MGDirection::for_all(&mut |i_dir| {
        ...
        match *p_kmdir {
            ...
            E(b) => {
                if b {
                    // 長東
                    Squares::looking_east_from(&Phase::First, square_dst, &mut |next_square| {
            ...
            NE(b) => {
                if b {
                    ...
                    // 北東
                    Squares::north_east_of(&Phase::First, square_dst, &mut |next_square| {
                        lookup_no_promotion_source_by_piece_next(
                            &ps_dst.piece,
                            current_board,
                            speed_of_light,
            ...
            NNE => {
                // 北北東
                Squares::north_east_keima_of(&Phase::First, square_dst, &mut |next_square| {
                    lookup_no_promotion_source_by_piece_next(
                        &ps_dst.piece,
                        current_board,
                        speed_of_light,
            ...
            N(b) => {
                if b {
                    // 長北
                    Squares::looking_north_from(&Phase::First, square_dst, &mut |next_square| {
                        lookup_no_promotion_source_by_piece_sliding(
                            &ps_dst.piece,
                            current_board,
                            speed_of_light,
            ...
            NNW => {
                // 北北西
                Squares::north_west_keima_of(&Phase::First, square_dst, &mut |next_square| {
                    lookup_no_promotion_source_by_piece_next(
                        &ps_dst.piece,
                        current_board,
                        speed_of_light,
            ...
            NW(b) => {
                if b {
                    ...
                    // 北西
                    Squares::north_west_of(&Phase::First, square_dst, &mut |next_square| {
                        lookup_no_promotion_source_by_piece_next(
                            &ps_dst.piece,
                            current_board,
                            speed_of_light,
            ...
            SW(b) => {
                if b {
                    ...
                    // 南西
                    Squares::south_west_of(&Phase::First, square_dst, &mut |next_square| {
                        lookup_no_promotion_source_by_piece_next(
                            &ps_dst.piece,
                            current_board,
                            speed_of_light,
            ...
            SSW => {
                // 南南西
                Squares::south_west_keima_of(&Phase::First, square_dst, &mut |next_square| {
                    lookup_no_promotion_source_by_piece_next(
                        &ps_dst.piece,
                        current_board,
                        speed_of_light,
            ...
            S(b) => {
                if b {
                    // 長南
                    Squares::looking_south_from(&Phase::First, square_dst, &mut |next_square| {
                        lookup_no_promotion_source_by_piece_sliding(
                            &ps_dst.piece,
                            current_board,
                            speed_of_light,
            ...
            SSE => {
                // 南南東
                Squares::south_east_keima_of(&Phase::First, square_dst, &mut |next_square| {
                    lookup_no_promotion_source_by_piece_next(
                        &ps_dst.piece,
                        current_board,
                        speed_of_light,
            ...
            SE(b) => {
                if b {
                    ...
                    // 南東
                    Squares::south_east_of(&Phase::First, square_dst, &mut |next_square| {
                        lookup_no_promotion_source_by_piece_next(
                            &ps_dst.piece,
                            current_board,
                            speed_of_light,
...
pub fn lookup_drop_by_square_piece<F1>(
    ...
    F1: FnMut(usize),
{
    assert_in_board(destination_sqp.square.address, "make_drop_by_square_piece");
    ...
    assert_in_board(sq.address, "Ｉnsert_da_piece_type_by_ms_km＜その２＞");
