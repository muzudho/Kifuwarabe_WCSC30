    ...
    MGDirection::for_all(&mut |i_dir| {
        ...
        match *p_kmdir {
            ...
            E(b) => {
                if b {
                    // 長東
                    Squares::looking_east_from(&source_sqps.square, &mut |next_square| {
                    ...
                    // 東
                    Squares::east_of(&source_sqps.square, &mut |next_square| {
            ...
            NE(b) => {
                if b {
                    // 長北東
                    Squares::looking_north_east_from(&source_sqps.square, &mut |next_square| {
                        make_destination_sliding(
                            &source_sqps.piece_struct.phase(),
                            current_position,
                            speed_of_light,
                    ...
                    // 北東
                    Squares::north_east_of(&source_sqps.square, &mut |next_square| {
                        make_destination_next(
                            &source_sqps.piece_struct.phase(),
                            current_position,
                            speed_of_light,
            ...
            NNE => {
                // 北北東
                Squares::north_east_keima_of(&source_sqps.square, &mut |next_square| {
                    make_destination_next(
                        &source_sqps.piece_struct.phase(),
                        current_position,
                        speed_of_light,
            ...
            N(b) => {
                if b {
                    // 長北
                    Squares::looking_north_from(&source_sqps.square, &mut |next_square| {
                        make_destination_sliding(
                            &source_sqps.piece_struct.phase(),
                            current_position,
                            speed_of_light,
                    ...
                    // 北
                    Squares::north_of(&source_sqps.square, &mut |next_square| {
                        make_destination_next(
                            &source_sqps.piece_struct.phase(),
                            current_position,
                            speed_of_light,
            ...
            NNW => {
                // 北北西
                Squares::north_west_keima_of(&source_sqps.square, &mut |next_square| {
                    make_destination_next(
                        &source_sqps.piece_struct.phase(),
                        current_position,
                        speed_of_light,
            ...
            NW(b) => {
                if b {
                    // 長北西
                    Squares::looking_north_west_from(&source_sqps.square, &mut |next_square| {
                        make_destination_sliding(
                            &source_sqps.piece_struct.phase(),
                            current_position,
                            speed_of_light,
                    ...
                    // 北西
                    Squares::north_west_of(&source_sqps.square, &mut |next_square| {
                        make_destination_next(
                            &source_sqps.piece_struct.phase(),
                            current_position,
                            speed_of_light,
            ...
            W(b) => {
                if b {
                    // 長西
                    Squares::looking_west_from(&source_sqps.square, &mut |next_square| {
                        make_destination_sliding(
                            &source_sqps.piece_struct.phase(),
                            current_position,
                            speed_of_light,
                    ...
                    // 西
                    Squares::west_of(&source_sqps.square, &mut |next_square| {
                        make_destination_next(
                            &source_sqps.piece_struct.phase(),
                            current_position,
                            speed_of_light,
            ...
            SW(b) => {
                if b {
                    // 長南西
                    Squares::looking_south_west_from(&source_sqps.square, &mut |next_square| {
                        make_destination_sliding(
                            &source_sqps.piece_struct.phase(),
                            current_position,
                            speed_of_light,
                    ...
                    // 南西
                    Squares::south_west_of(&source_sqps.square, &mut |next_square| {
                        make_destination_next(
                            &source_sqps.piece_struct.phase(),
                            current_position,
                            speed_of_light,
            ...
            SSW => {
                // 南南西
                Squares::south_west_keima_of(&source_sqps.square, &mut |next_square| {
                    make_destination_next(
                        &source_sqps.piece_struct.phase(),
                        current_position,
                        speed_of_light,
            ...
            S(b) => {
                if b {
                    // 長南
                    Squares::looking_south_from(&source_sqps.square, &mut |next_square| {
                        make_destination_sliding(
                            &source_sqps.piece_struct.phase(),
                            current_position,
                            speed_of_light,
                    ...
                    // 南
                    Squares::south_of(&source_sqps.square, &mut |next_square| {
                        make_destination_next(
                            &source_sqps.piece_struct.phase(),
                            current_position,
                            speed_of_light,
            ...
            SSE => {
                // 南南東
                Squares::south_east_keima_of(&source_sqps.square, &mut |next_square| {
                    make_destination_next(
                        &source_sqps.piece_struct.phase(),
                        current_position,
                        speed_of_light,
            ...
            SE(b) => {
                if b {
                    // 長南東
                    Squares::looking_south_east_from(&source_sqps.square, &mut |next_square| {
                        make_destination_sliding(
                            &source_sqps.piece_struct.phase(),
                            current_position,
                            speed_of_light,
                    ...
                    // 南東
                    Squares::south_east_of(&source_sqps.square, &mut |next_square| {
                        make_destination_next(
                            &source_sqps.piece_struct.phase(),
                            current_position,
                            speed_of_light,
