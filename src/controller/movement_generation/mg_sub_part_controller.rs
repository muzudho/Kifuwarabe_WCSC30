    ...
    for i_dir in 0..KM_UGOKI_LN {
        ...
        match *p_kmdir {
            ...
            E(b) => {
                if b {
                    // 長東
                    MGLinedSquares::for_each_east(square_dst, &mut |next_square| {
                    ...
                    // 東
                    MGSquare::east_of(square_dst, &mut |next_square| {
            ...
            NE(b) => {
                if b {
                    // 長北東
                    MGLinedSquares::for_each_north_east(square_dst, &mut |next_square| {
                        lookup_no_promotion_source_by_piece_sliding(
                            ps_dst.piece(),
                            current_position,
                            speed_of_light,
                    ...
                    // 北東
                    MGSquare::north_east_of(square_dst, &mut |next_square| {
                        lookup_no_promotion_source_by_piece_next(
                            ps_dst.piece(),
                            current_position,
                            speed_of_light,
            ...
            NNE => {
                // 北北東
                MGSquare::north_north_east_of(square_dst, &mut |next_square| {
                    lookup_no_promotion_source_by_piece_next(
                        ps_dst.piece(),
                        current_position,
                        speed_of_light,
            ...
            N(b) => {
                if b {
                    // 長北
                    MGLinedSquares::for_each_north(square_dst, &mut |next_square| {
                        lookup_no_promotion_source_by_piece_sliding(
                            ps_dst.piece(),
                            current_position,
                            speed_of_light,
                    ...
                    // 北
                    MGSquare::north_of(square_dst, &mut |next_square| {
                        lookup_no_promotion_source_by_piece_next(
                            ps_dst.piece(),
                            current_position,
                            speed_of_light,
            ...
            NNW => {
                // 北北西
                MGSquare::north_north_west_of(square_dst, &mut |next_square| {
                    lookup_no_promotion_source_by_piece_next(
                        ps_dst.piece(),
                        current_position,
                        speed_of_light,
            ...
            NW(b) => {
                if b {
                    // 長北西
                    MGLinedSquares::for_each_north_west(square_dst, &mut |next_square| {
                        lookup_no_promotion_source_by_piece_sliding(
                            ps_dst.piece(),
                            current_position,
                            speed_of_light,
                    ...
                    // 北西
                    MGSquare::north_west_of(square_dst, &mut |next_square| {
                        lookup_no_promotion_source_by_piece_next(
                            ps_dst.piece(),
                            current_position,
                            speed_of_light,
            ...
            W(b) => {
                if b {
                    // 長西
                    MGLinedSquares::for_each_west(square_dst, &mut |next_square| {
                        lookup_no_promotion_source_by_piece_sliding(
                            ps_dst.piece(),
                            current_position,
                            speed_of_light,
                    ...
                    // 西
                    MGSquare::west_of(square_dst, &mut |next_square| {
                        lookup_no_promotion_source_by_piece_next(
                            ps_dst.piece(),
                            current_position,
                            speed_of_light,
            ...
            SW(b) => {
                if b {
                    // 長南西
                    MGLinedSquares::for_each_south_west(square_dst, &mut |next_square| {
                        lookup_no_promotion_source_by_piece_sliding(
                            ps_dst.piece(),
                            current_position,
                            speed_of_light,
                    ...
                    // 南西
                    MGSquare::south_west_of(square_dst, &mut |next_square| {
                        lookup_no_promotion_source_by_piece_next(
                            ps_dst.piece(),
                            current_position,
                            speed_of_light,
            ...
            SSW => {
                // 南南西
                MGSquare::south_south_west_of(square_dst, &mut |next_square| {
                    lookup_no_promotion_source_by_piece_next(
                        ps_dst.piece(),
                        current_position,
                        speed_of_light,
            ...
            S(b) => {
                if b {
                    // 長南
                    MGLinedSquares::for_each_south(square_dst, &mut |next_square| {
                        lookup_no_promotion_source_by_piece_sliding(
                            ps_dst.piece(),
                            current_position,
                            speed_of_light,
                    ...
                    // 南
                    MGSquare::south_of(square_dst, &mut |next_square| {
                        lookup_no_promotion_source_by_piece_next(
                            ps_dst.piece(),
                            current_position,
                            speed_of_light,
            ...
            SSE => {
                // 南南東
                MGSquare::south_south_east_of(square_dst, &mut |next_square| {
                    lookup_no_promotion_source_by_piece_next(
                        ps_dst.piece(),
                        current_position,
                        speed_of_light,
            ...
            SE(b) => {
                if b {
                    // 長南東
                    MGLinedSquares::for_each_south_east(square_dst, &mut |next_square| {
                        lookup_no_promotion_source_by_piece_sliding(
                            ps_dst.piece(),
                            current_position,
                            speed_of_light,
                    ...
                    // 南東
                    MGSquare::south_east_of(square_dst, &mut |next_square| {
                        lookup_no_promotion_source_by_piece_next(
                            ps_dst.piece(),
                            current_position,
                            speed_of_light,
        ...
        match *p_kmdir {
            ...
            E(b) => {
                if b {
                    ...
                    // 東
                    MGSquare::east_of(&square_dst_piece_src.square, &mut |next_square| {
            ...
            NE(b) => {
                if b {
                    // 長北東
                    MGLinedSquares::for_each_north_east(
                        &square_dst_piece_src.square,
                        &mut |next_square| {
                            lookup_before_promotion_source_sliding(
                                &square_dst_piece_src.piece,
                    ...
                    // 北東
                    MGSquare::north_east_of(&square_dst_piece_src.square, &mut |next_square| {
                        lookup_before_promotion_source_next(
                            &square_dst_piece_src.piece,
                            current_position,
                            speed_of_light,
            ...
            NNE => {
                // 北北東
                MGSquare::north_north_east_of(&square_dst_piece_src.square, &mut |next_square| {
                    lookup_before_promotion_source_next(
                        &square_dst_piece_src.piece,
                        current_position,
                        speed_of_light,
            ...
            N(b) => {
                if b {
                    ...
                    // 北
                    MGSquare::north_of(&square_dst_piece_src.square, &mut |next_square| {
                        lookup_before_promotion_source_next(
                            &square_dst_piece_src.piece,
                            current_position,
                            speed_of_light,
            ...
            NNW => {
                // 北北西
                MGSquare::north_north_west_of(&square_dst_piece_src.square, &mut |next_square| {
                    lookup_before_promotion_source_next(
                        &square_dst_piece_src.piece,
                        current_position,
                        speed_of_light,
            ...
            NW(b) => {
                if b {
                    // 長北西
                    MGLinedSquares::for_each_north_west(
                        &square_dst_piece_src.square,
                        &mut |next_square| {
                            lookup_before_promotion_source_sliding(
                                &square_dst_piece_src.piece,
                    ...
                    // 北西
                    MGSquare::north_west_of(&square_dst_piece_src.square, &mut |next_square| {
                        lookup_before_promotion_source_next(
                            &square_dst_piece_src.piece,
                            current_position,
                            speed_of_light,
            ...
            W(b) => {
                if b {
                    ...
                    // 西
                    MGSquare::west_of(&square_dst_piece_src.square, &mut |next_square| {
                        lookup_before_promotion_source_next(
                            &square_dst_piece_src.piece,
                            current_position,
                            speed_of_light,
            ...
            SW(b) => {
                if b {
                    // 長南西
                    MGLinedSquares::for_each_south_west(
                        &square_dst_piece_src.square,
                        &mut |next_square| {
                            lookup_before_promotion_source_sliding(
                                &square_dst_piece_src.piece,
                    ...
                    // 南西
                    MGSquare::south_west_of(&square_dst_piece_src.square, &mut |next_square| {
                        lookup_before_promotion_source_next(
                            &square_dst_piece_src.piece,
                            current_position,
                            speed_of_light,
            ...
            SSW => {
                // 南南西
                MGSquare::south_south_west_of(&square_dst_piece_src.square, &mut |next_square| {
                    lookup_before_promotion_source_next(
                        &square_dst_piece_src.piece,
                        current_position,
                        speed_of_light,
            ...
            S(b) => {
                if b {
                    ...
                    // 南
                    MGSquare::south_of(&square_dst_piece_src.square, &mut |next_square| {
                        lookup_before_promotion_source_next(
                            &square_dst_piece_src.piece,
                            current_position,
                            speed_of_light,
            ...
            SSE => {
                // 南南東
                MGSquare::south_south_east_of(&square_dst_piece_src.square, &mut |next_square| {
                    lookup_before_promotion_source_next(
                        &square_dst_piece_src.piece,
                        current_position,
                        speed_of_light,
            ...
            SE(b) => {
                if b {
                    // 長南東
                    MGLinedSquares::for_each_south_east(
                        &square_dst_piece_src.square,
                        &mut |next_square| {
                            lookup_before_promotion_source_sliding(
                                &square_dst_piece_src.piece,
                    ...
                    // 南東
                    MGSquare::south_east_of(&square_dst_piece_src.square, &mut |next_square| {
                        lookup_before_promotion_source_next(
                            &square_dst_piece_src.piece,
                            current_position,
                            speed_of_light,
    ...
    for i_dir in 0..KM_UGOKI_LN {
        ...
        match *p_kmdir {
            ...
            E(b) => {
                if b {
                    // 長東
                    MGLinedSquares::for_each_east(&source_sqps.square, &mut |next_square| {
                    ...
                    // 東
                    MGSquare::east_of(&source_sqps.square, &mut |next_square| {
            ...
            NE(b) => {
                if b {
                    // 長北東
                    MGLinedSquares::for_each_north_east(&source_sqps.square, &mut |next_square| {
                        make_destination_sliding(
                            &source_sqps.piece_struct.phase(),
                            current_position,
                            speed_of_light,
                    ...
                    // 北東
                    MGSquare::north_east_of(&source_sqps.square, &mut |next_square| {
                        make_destination_next(
                            &source_sqps.piece_struct.phase(),
                            current_position,
                            speed_of_light,
            ...
            NNE => {
                // 北北東
                MGSquare::north_north_east_of(&source_sqps.square, &mut |next_square| {
                    make_destination_next(
                        &source_sqps.piece_struct.phase(),
                        current_position,
                        speed_of_light,
            ...
            N(b) => {
                if b {
                    // 長北
                    MGLinedSquares::for_each_north(&source_sqps.square, &mut |next_square| {
                        make_destination_sliding(
                            &source_sqps.piece_struct.phase(),
                            current_position,
                            speed_of_light,
                    ...
                    // 北
                    MGSquare::north_of(&source_sqps.square, &mut |next_square| {
                        make_destination_next(
                            &source_sqps.piece_struct.phase(),
                            current_position,
                            speed_of_light,
            ...
            NNW => {
                // 北北西
                MGSquare::north_north_west_of(&source_sqps.square, &mut |next_square| {
                    make_destination_next(
                        &source_sqps.piece_struct.phase(),
                        current_position,
                        speed_of_light,
            ...
            NW(b) => {
                if b {
                    // 長北西
                    MGLinedSquares::for_each_north_west(&source_sqps.square, &mut |next_square| {
                        make_destination_sliding(
                            &source_sqps.piece_struct.phase(),
                            current_position,
                            speed_of_light,
                    ...
                    // 北西
                    MGSquare::north_west_of(&source_sqps.square, &mut |next_square| {
                        make_destination_next(
                            &source_sqps.piece_struct.phase(),
                            current_position,
                            speed_of_light,
            ...
            W(b) => {
                if b {
                    // 長西
                    MGLinedSquares::for_each_west(&source_sqps.square, &mut |next_square| {
                        make_destination_sliding(
                            &source_sqps.piece_struct.phase(),
                            current_position,
                            speed_of_light,
                    ...
                    // 西
                    MGSquare::west_of(&source_sqps.square, &mut |next_square| {
                        make_destination_next(
                            &source_sqps.piece_struct.phase(),
                            current_position,
                            speed_of_light,
            ...
            SW(b) => {
                if b {
                    // 長南西
                    MGLinedSquares::for_each_south_west(&source_sqps.square, &mut |next_square| {
                        make_destination_sliding(
                            &source_sqps.piece_struct.phase(),
                            current_position,
                            speed_of_light,
                    ...
                    // 南西
                    MGSquare::south_west_of(&source_sqps.square, &mut |next_square| {
                        make_destination_next(
                            &source_sqps.piece_struct.phase(),
                            current_position,
                            speed_of_light,
            ...
            SSW => {
                // 南南西
                MGSquare::south_south_west_of(&source_sqps.square, &mut |next_square| {
                    make_destination_next(
                        &source_sqps.piece_struct.phase(),
                        current_position,
                        speed_of_light,
            ...
            S(b) => {
                if b {
                    // 長南
                    MGLinedSquares::for_each_south(&source_sqps.square, &mut |next_square| {
                        make_destination_sliding(
                            &source_sqps.piece_struct.phase(),
                            current_position,
                            speed_of_light,
                    ...
                    // 南
                    MGSquare::south_of(&source_sqps.square, &mut |next_square| {
                        make_destination_next(
                            &source_sqps.piece_struct.phase(),
                            current_position,
                            speed_of_light,
            ...
            SSE => {
                // 南南東
                MGSquare::south_south_east_of(&source_sqps.square, &mut |next_square| {
                    make_destination_next(
                        &source_sqps.piece_struct.phase(),
                        current_position,
                        speed_of_light,
            ...
            SE(b) => {
                if b {
                    // 長南東
                    MGLinedSquares::for_each_south_east(&source_sqps.square, &mut |next_square| {
                        make_destination_sliding(
                            &source_sqps.piece_struct.phase(),
                            current_position,
                            speed_of_light,
                    ...
                    // 南東
                    MGSquare::south_east_of(&source_sqps.square, &mut |next_square| {
                        make_destination_next(
                            &source_sqps.piece_struct.phase(),
                            current_position,
                            speed_of_light,
        ...
        for i_dir in 0..KM_UGOKI_LN {
            ...
            match *p_kmdir {
                ...
                E(b) => {
                    if b {
                        // 長東
                        MGLinedSquares::for_each_east(&dst_sq_piece.square, &mut |next_square| {
                        ...
                        // 東
                        MGSquare::east_of(&dst_sq_piece.square, &mut |next_square| {
                ...
                NE(b) => {
                    if b {
                        ...
                        // 北東
                        MGSquare::north_east_of(&dst_sq_piece.square, &mut |next_square| {
                            lookup_no_promotion_source_by_phase_next(
                                &dst_sq_piece,
                                current_position,
                                &mut lookups_the_square,
                ...
                NNE => {
                    // 北北東
                    MGSquare::north_north_east_of(&dst_sq_piece.square, &mut |next_square| {
                        lookup_no_promotion_source_by_phase_next(
                            &dst_sq_piece,
                            current_position,
                            &mut lookups_the_square,
                ...
                N(b) => {
                    if b {
                        // 長北
                        MGLinedSquares::for_each_north(&dst_sq_piece.square, &mut |next_square| {
                            lookup_no_promotion_source_by_phase_sliding(
                                &dst_sq_piece,
                                current_position,
                                &mut lookups_the_square,
                        ...
                        // 北
                        MGSquare::north_of(&dst_sq_piece.square, &mut |next_square| {
                            lookup_no_promotion_source_by_phase_next(
                                &dst_sq_piece,
                                current_position,
                                &mut lookups_the_square,
                ...
                NNW => {
                    // 北北西
                    MGSquare::north_north_west_of(&dst_sq_piece.square, &mut |next_square| {
                        lookup_no_promotion_source_by_phase_next(
                            &dst_sq_piece,
                            current_position,
                            &mut lookups_the_square,
                ...
                NW(b) => {
                    if b {
                        ...
                        // 北西
                        MGSquare::north_west_of(&dst_sq_piece.square, &mut |next_square| {
                            lookup_no_promotion_source_by_phase_next(
                                &dst_sq_piece,
                                current_position,
                                &mut lookups_the_square,
                ...
                W(b) => {
                    if b {
                        // 長西
                        MGLinedSquares::for_each_west(&dst_sq_piece.square, &mut |next_square| {
                            lookup_no_promotion_source_by_phase_sliding(
                                &dst_sq_piece,
                                current_position,
                                &mut lookups_the_square,
                        ...
                        // 西
                        MGSquare::west_of(&dst_sq_piece.square, &mut |next_square| {
                            lookup_no_promotion_source_by_phase_next(
                                &dst_sq_piece,
                                current_position,
                                &mut lookups_the_square,
                ...
                SW(b) => {
                    if b {
                        ...
                        // 南西
                        MGSquare::south_west_of(&dst_sq_piece.square, &mut |next_square| {
                            lookup_no_promotion_source_by_phase_next(
                                &dst_sq_piece,
                                current_position,
                                &mut lookups_the_square,
                ...
                SSW => {
                    // 南南西
                    MGSquare::south_south_west_of(&dst_sq_piece.square, &mut |next_square| {
                        lookup_no_promotion_source_by_phase_next(
                            &dst_sq_piece,
                            current_position,
                            &mut lookups_the_square,
                ...
                S(b) => {
                    if b {
                        // 長南
                        MGLinedSquares::for_each_south(&dst_sq_piece.square, &mut |next_square| {
                            lookup_no_promotion_source_by_phase_sliding(
                                &dst_sq_piece,
                                current_position,
                                &mut lookups_the_square,
                        ...
                        // 南
                        MGSquare::south_of(&dst_sq_piece.square, &mut |next_square| {
                            lookup_no_promotion_source_by_phase_next(
                                &dst_sq_piece,
                                current_position,
                                &mut lookups_the_square,
                ...
                SSE => {
                    // 南南東
                    MGSquare::south_south_east_of(&dst_sq_piece.square, &mut |next_square| {
                        lookup_no_promotion_source_by_phase_next(
                            &dst_sq_piece,
                            current_position,
                            &mut lookups_the_square,
                ...
                SE(b) => {
                    if b {
                        ...
                        // 南東
                        MGSquare::south_east_of(&dst_sq_piece.square, &mut |next_square| {
                            lookup_no_promotion_source_by_phase_next(
                                &dst_sq_piece,
                                current_position,
                                &mut lookups_the_square,
            ...
            match *p_kmdir {
                ...
                E(b) => {
                    if b {
                        ...
                        // 東
                        MGSquare::east_of(&dst_sq_and_demoted_piece.square, &mut |next_square| {
                ...
                N(b) => {
                    if b {
                        ...
                        // 北
                        MGSquare::north_of(&dst_sq_and_demoted_piece.square, &mut |next_square| {
                            lookup_before_promotion_source_by_phase_next(
                                &dst_sq_and_demoted_piece,
                                current_position,
                                &mut lookups_the_square,
                ...
                W(b) => {
                    if b {
                        ...
                        // 西
                        MGSquare::west_of(&dst_sq_and_demoted_piece.square, &mut |next_square| {
                            lookup_before_promotion_source_by_phase_next(
                                &dst_sq_and_demoted_piece,
                                current_position,
                                &mut lookups_the_square,
                ...
                S(b) => {
                    if b {
                        ...
                        // 南
                        MGSquare::south_of(&dst_sq_and_demoted_piece.square, &mut |next_square| {
                            lookup_before_promotion_source_by_phase_next(
                                &dst_sq_and_demoted_piece,
                                current_position,
                                &mut lookups_the_square,
