...
impl Uchu {
    ...
    pub fn copy_ky0_to_ky1(&mut self) {
        ...
        for i_ms in 0..BAN_SIZE {
            self.ky
                .set_km_by_ms(i_ms, self.ky0.get_piece_struct_by_ms(i_ms).piece());
        }
        // 持ち駒
        for i_mg in 0..KM_LN {
...
▼      a1 |{72}|{73}|{74}|{75}|{76}|{77}|{78}|{79}|{80}|   △
           +----+----+----+----+----+----+----+----+----+
              1    2    3    4    5    6    7    8    9\
",
            ky.get_piece_struct_by_ms(19).piece(),
            ky.get_piece_struct_by_ms(29).piece(),
            ky.get_piece_struct_by_ms(39).piece(),
            ky.get_piece_struct_by_ms(49).piece(),
            ky.get_piece_struct_by_ms(59).piece(),
            ky.get_piece_struct_by_ms(69).piece(),
            ky.get_piece_struct_by_ms(79).piece(),
            ky.get_piece_struct_by_ms(89).piece(),
            ky.get_piece_struct_by_ms(99).piece(),
            ky.get_piece_struct_by_ms(18).piece(),
            ky.get_piece_struct_by_ms(28).piece(),
            ky.get_piece_struct_by_ms(38).piece(),
            ky.get_piece_struct_by_ms(48).piece(),
            ky.get_piece_struct_by_ms(58).piece(),
            ky.get_piece_struct_by_ms(68).piece(),
            ky.get_piece_struct_by_ms(78).piece(),
            ky.get_piece_struct_by_ms(88).piece(),
            ky.get_piece_struct_by_ms(98).piece(),
            ky.get_piece_struct_by_ms(17).piece(),
            ky.get_piece_struct_by_ms(27).piece(),
            ky.get_piece_struct_by_ms(37).piece(),
            ky.get_piece_struct_by_ms(47).piece(),
            ky.get_piece_struct_by_ms(57).piece(),
            ky.get_piece_struct_by_ms(67).piece(),
            ky.get_piece_struct_by_ms(77).piece(),
            ky.get_piece_struct_by_ms(87).piece(),
            ky.get_piece_struct_by_ms(97).piece(),
            ky.get_piece_struct_by_ms(16).piece(),
            ky.get_piece_struct_by_ms(26).piece(),
            ky.get_piece_struct_by_ms(36).piece(),
            ky.get_piece_struct_by_ms(46).piece(),
            ky.get_piece_struct_by_ms(56).piece(),
            ky.get_piece_struct_by_ms(66).piece(),
            ky.get_piece_struct_by_ms(76).piece(),
            ky.get_piece_struct_by_ms(86).piece(),
            ky.get_piece_struct_by_ms(96).piece(),
            ky.get_piece_struct_by_ms(15).piece(),
            ky.get_piece_struct_by_ms(25).piece(),
            ky.get_piece_struct_by_ms(35).piece(),
            ky.get_piece_struct_by_ms(45).piece(),
            ky.get_piece_struct_by_ms(55).piece(),
            ky.get_piece_struct_by_ms(65).piece(),
            ky.get_piece_struct_by_ms(75).piece(),
            ky.get_piece_struct_by_ms(85).piece(),
            ky.get_piece_struct_by_ms(95).piece(),
            ky.get_piece_struct_by_ms(14).piece(),
            ky.get_piece_struct_by_ms(24).piece(),
            ky.get_piece_struct_by_ms(34).piece(),
            ky.get_piece_struct_by_ms(44).piece(),
            ky.get_piece_struct_by_ms(54).piece(),
            ky.get_piece_struct_by_ms(64).piece(),
            ky.get_piece_struct_by_ms(74).piece(),
            ky.get_piece_struct_by_ms(84).piece(),
            ky.get_piece_struct_by_ms(94).piece(),
            ky.get_piece_struct_by_ms(13).piece(),
            ky.get_piece_struct_by_ms(23).piece(),
            ky.get_piece_struct_by_ms(33).piece(),
            ky.get_piece_struct_by_ms(43).piece(),
            ky.get_piece_struct_by_ms(53).piece(),
            ky.get_piece_struct_by_ms(63).piece(),
            ky.get_piece_struct_by_ms(73).piece(),
            ky.get_piece_struct_by_ms(83).piece(),
            ky.get_piece_struct_by_ms(93).piece(),
            ky.get_piece_struct_by_ms(12).piece(),
            ky.get_piece_struct_by_ms(22).piece(),
            ky.get_piece_struct_by_ms(32).piece(),
            ky.get_piece_struct_by_ms(42).piece(),
            ky.get_piece_struct_by_ms(52).piece(),
            ky.get_piece_struct_by_ms(62).piece(),
            ky.get_piece_struct_by_ms(72).piece(),
            ky.get_piece_struct_by_ms(82).piece(),
            ky.get_piece_struct_by_ms(92).piece(),
            ky.get_piece_struct_by_ms(11).piece(),
            ky.get_piece_struct_by_ms(21).piece(),
            ky.get_piece_struct_by_ms(31).piece(),
            ky.get_piece_struct_by_ms(41).piece(),
            ky.get_piece_struct_by_ms(51).piece(),
            ky.get_piece_struct_by_ms(61).piece(),
            ky.get_piece_struct_by_ms(71).piece(),
            ky.get_piece_struct_by_ms(81).piece(),
            ky.get_piece_struct_by_ms(91).piece(),
            //                   ▲き,　                   ▲ぞ,                     ▲い,                     ▲ね,                     ▲う,                     ▲し,                     ▲ひ,
