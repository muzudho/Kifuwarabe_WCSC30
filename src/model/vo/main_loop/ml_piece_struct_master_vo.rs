    ...
    pub fn get_piece_vo_by_phase_and_piece_type(
        ...
        match *phase {
            Phase::First => match piece_type {
                ...
                Dragon => self.get_piece_vo(&PromotedRook1),
                Horse => self.get_piece_vo(&PromotedBishop1),
            ...
            Phase::Second => match piece_type {
                ...
                Dragon => self.get_piece_vo(&PromotedRook2),
                Horse => self.get_piece_vo(&PromotedBishop2),
