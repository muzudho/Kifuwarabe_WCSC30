...
P x{87:2}   |{63}|{64}|{65}|{66}|{67}|{68}|{69}|{70}|{71}| h    p x{94:2}
        ...
        +----+----+----+----+----+----+----+----+----+\
",
                        GameRoom::to_string2(position.piece_at_board(Square::new(91u8))),
                        GameRoom::to_string2(position.piece_at_board(Square::new(81u8))),
                        GameRoom::to_string2(position.piece_at_board(Square::new(71u8))),
                        GameRoom::to_string2(position.piece_at_board(Square::new(61u8))),
                        GameRoom::to_string2(position.piece_at_board(Square::new(51u8))),
                        GameRoom::to_string2(position.piece_at_board(Square::new(41u8))),
                        GameRoom::to_string2(position.piece_at_board(Square::new(31u8))),
                        GameRoom::to_string2(position.piece_at_board(Square::new(21u8))),
                        GameRoom::to_string2(position.piece_at_board(Square::new(11u8))),
                        GameRoom::to_string2(position.piece_at_board(Square::new(92u8))),
                        GameRoom::to_string2(position.piece_at_board(Square::new(82u8))),
                        GameRoom::to_string2(position.piece_at_board(Square::new(72u8))),
                        GameRoom::to_string2(position.piece_at_board(Square::new(62u8))),
                        GameRoom::to_string2(position.piece_at_board(Square::new(52u8))),
                        GameRoom::to_string2(position.piece_at_board(Square::new(42u8))),
                        GameRoom::to_string2(position.piece_at_board(Square::new(32u8))),
                        GameRoom::to_string2(position.piece_at_board(Square::new(22u8))),
                        GameRoom::to_string2(position.piece_at_board(Square::new(12u8))),
                        GameRoom::to_string2(position.piece_at_board(Square::new(93u8))),
                        GameRoom::to_string2(position.piece_at_board(Square::new(83u8))),
                        GameRoom::to_string2(position.piece_at_board(Square::new(73u8))),
                        GameRoom::to_string2(position.piece_at_board(Square::new(63u8))),
                        GameRoom::to_string2(position.piece_at_board(Square::new(53u8))),
                        GameRoom::to_string2(position.piece_at_board(Square::new(43u8))),
                        GameRoom::to_string2(position.piece_at_board(Square::new(33u8))),
                        GameRoom::to_string2(position.piece_at_board(Square::new(23u8))),
                        GameRoom::to_string2(position.piece_at_board(Square::new(13u8))),
                        GameRoom::to_string2(position.piece_at_board(Square::new(94u8))),
                        GameRoom::to_string2(position.piece_at_board(Square::new(84u8))),
                        GameRoom::to_string2(position.piece_at_board(Square::new(74u8))),
                        GameRoom::to_string2(position.piece_at_board(Square::new(64u8))),
                        GameRoom::to_string2(position.piece_at_board(Square::new(54u8))),
                        GameRoom::to_string2(position.piece_at_board(Square::new(44u8))),
                        GameRoom::to_string2(position.piece_at_board(Square::new(34u8))),
                        GameRoom::to_string2(position.piece_at_board(Square::new(24u8))),
                        GameRoom::to_string2(position.piece_at_board(Square::new(14u8))),
                        GameRoom::to_string2(position.piece_at_board(Square::new(95u8))),
                        GameRoom::to_string2(position.piece_at_board(Square::new(85u8))),
                        GameRoom::to_string2(position.piece_at_board(Square::new(75u8))),
                        GameRoom::to_string2(position.piece_at_board(Square::new(65u8))),
                        GameRoom::to_string2(position.piece_at_board(Square::new(55u8))),
                        GameRoom::to_string2(position.piece_at_board(Square::new(45u8))),
                        GameRoom::to_string2(position.piece_at_board(Square::new(35u8))),
                        GameRoom::to_string2(position.piece_at_board(Square::new(25u8))),
                        GameRoom::to_string2(position.piece_at_board(Square::new(15u8))),
                        GameRoom::to_string2(position.piece_at_board(Square::new(96u8))),
                        GameRoom::to_string2(position.piece_at_board(Square::new(86u8))),
                        GameRoom::to_string2(position.piece_at_board(Square::new(76u8))),
                        GameRoom::to_string2(position.piece_at_board(Square::new(66u8))),
                        GameRoom::to_string2(position.piece_at_board(Square::new(56u8))),
                        GameRoom::to_string2(position.piece_at_board(Square::new(46u8))),
                        GameRoom::to_string2(position.piece_at_board(Square::new(36u8))),
                        GameRoom::to_string2(position.piece_at_board(Square::new(26u8))),
                        GameRoom::to_string2(position.piece_at_board(Square::new(16u8))),
                        GameRoom::to_string2(position.piece_at_board(Square::new(97u8))),
                        GameRoom::to_string2(position.piece_at_board(Square::new(87u8))),
                        GameRoom::to_string2(position.piece_at_board(Square::new(77u8))),
                        GameRoom::to_string2(position.piece_at_board(Square::new(67u8))),
                        GameRoom::to_string2(position.piece_at_board(Square::new(57u8))),
                        GameRoom::to_string2(position.piece_at_board(Square::new(47u8))),
                        GameRoom::to_string2(position.piece_at_board(Square::new(37u8))),
                        GameRoom::to_string2(position.piece_at_board(Square::new(27u8))),
                        GameRoom::to_string2(position.piece_at_board(Square::new(17u8))),
                        GameRoom::to_string2(position.piece_at_board(Square::new(98u8))),
                        GameRoom::to_string2(position.piece_at_board(Square::new(88u8))),
                        GameRoom::to_string2(position.piece_at_board(Square::new(78u8))),
                        GameRoom::to_string2(position.piece_at_board(Square::new(68u8))),
                        GameRoom::to_string2(position.piece_at_board(Square::new(58u8))),
                        GameRoom::to_string2(position.piece_at_board(Square::new(48u8))),
                        GameRoom::to_string2(position.piece_at_board(Square::new(38u8))),
                        GameRoom::to_string2(position.piece_at_board(Square::new(28u8))),
                        GameRoom::to_string2(position.piece_at_board(Square::new(18u8))),
                        GameRoom::to_string2(position.piece_at_board(Square::new(99u8))),
                        GameRoom::to_string2(position.piece_at_board(Square::new(89u8))),
                        GameRoom::to_string2(position.piece_at_board(Square::new(79u8))),
                        GameRoom::to_string2(position.piece_at_board(Square::new(69u8))),
                        GameRoom::to_string2(position.piece_at_board(Square::new(59u8))),
                        GameRoom::to_string2(position.piece_at_board(Square::new(49u8))),
                        GameRoom::to_string2(position.piece_at_board(Square::new(39u8))),
                        GameRoom::to_string2(position.piece_at_board(Square::new(29u8))),
                        GameRoom::to_string2(position.piece_at_board(Square::new(19u8))),
                        //                   ▲き,　                   ▲ぞ,                     ▲い,                     ▲ね,                     ▲う,                     ▲し,                     ▲ひ,
