...
P x{87:2}   |{63}|{64}|{65}|{66}|{67}|{68}|{69}|{70}|{71}| h8   p x{94:2}
        ...
        +----+----+----+----+----+----+----+----+----+\
",
            GameRoom::to_string2(position.piece_at(&AbsoluteAddress::new(9, 1))),
            GameRoom::to_string2(position.piece_at(&AbsoluteAddress::new(8, 1))),
            GameRoom::to_string2(position.piece_at(&AbsoluteAddress::new(7, 1))),
            GameRoom::to_string2(position.piece_at(&AbsoluteAddress::new(6, 1))),
            GameRoom::to_string2(position.piece_at(&AbsoluteAddress::new(5, 1))),
            GameRoom::to_string2(position.piece_at(&AbsoluteAddress::new(4, 1))),
            GameRoom::to_string2(position.piece_at(&AbsoluteAddress::new(3, 1))),
            GameRoom::to_string2(position.piece_at(&AbsoluteAddress::new(2, 1))),
            GameRoom::to_string2(position.piece_at(&AbsoluteAddress::new(1, 1))),
            GameRoom::to_string2(position.piece_at(&AbsoluteAddress::new(9, 2))),
            GameRoom::to_string2(position.piece_at(&AbsoluteAddress::new(8, 2))),
            GameRoom::to_string2(position.piece_at(&AbsoluteAddress::new(7, 2))),
            GameRoom::to_string2(position.piece_at(&AbsoluteAddress::new(6, 2))),
            GameRoom::to_string2(position.piece_at(&AbsoluteAddress::new(5, 2))),
            GameRoom::to_string2(position.piece_at(&AbsoluteAddress::new(4, 2))),
            GameRoom::to_string2(position.piece_at(&AbsoluteAddress::new(3, 2))),
            GameRoom::to_string2(position.piece_at(&AbsoluteAddress::new(2, 2))),
            GameRoom::to_string2(position.piece_at(&AbsoluteAddress::new(1, 2))),
            GameRoom::to_string2(position.piece_at(&AbsoluteAddress::new(9, 3))),
            GameRoom::to_string2(position.piece_at(&AbsoluteAddress::new(8, 3))),
            GameRoom::to_string2(position.piece_at(&AbsoluteAddress::new(7, 3))),
            GameRoom::to_string2(position.piece_at(&AbsoluteAddress::new(6, 3))),
            GameRoom::to_string2(position.piece_at(&AbsoluteAddress::new(5, 3))),
            GameRoom::to_string2(position.piece_at(&AbsoluteAddress::new(4, 3))),
            GameRoom::to_string2(position.piece_at(&AbsoluteAddress::new(3, 3))),
            GameRoom::to_string2(position.piece_at(&AbsoluteAddress::new(2, 3))),
            GameRoom::to_string2(position.piece_at(&AbsoluteAddress::new(1, 3))),
            GameRoom::to_string2(position.piece_at(&AbsoluteAddress::new(9, 4))),
            GameRoom::to_string2(position.piece_at(&AbsoluteAddress::new(8, 4))),
            GameRoom::to_string2(position.piece_at(&AbsoluteAddress::new(7, 4))),
            GameRoom::to_string2(position.piece_at(&AbsoluteAddress::new(6, 4))),
            GameRoom::to_string2(position.piece_at(&AbsoluteAddress::new(5, 4))),
            GameRoom::to_string2(position.piece_at(&AbsoluteAddress::new(4, 4))),
            GameRoom::to_string2(position.piece_at(&AbsoluteAddress::new(3, 4))),
            GameRoom::to_string2(position.piece_at(&AbsoluteAddress::new(2, 4))),
            GameRoom::to_string2(position.piece_at(&AbsoluteAddress::new(1, 4))),
            GameRoom::to_string2(position.piece_at(&AbsoluteAddress::new(9, 5))),
            GameRoom::to_string2(position.piece_at(&AbsoluteAddress::new(8, 5))),
            GameRoom::to_string2(position.piece_at(&AbsoluteAddress::new(7, 5))),
            GameRoom::to_string2(position.piece_at(&AbsoluteAddress::new(6, 5))),
            GameRoom::to_string2(position.piece_at(&AbsoluteAddress::new(5, 5))),
            GameRoom::to_string2(position.piece_at(&AbsoluteAddress::new(4, 5))),
            GameRoom::to_string2(position.piece_at(&AbsoluteAddress::new(3, 5))),
            GameRoom::to_string2(position.piece_at(&AbsoluteAddress::new(2, 5))),
            GameRoom::to_string2(position.piece_at(&AbsoluteAddress::new(1, 5))),
            GameRoom::to_string2(position.piece_at(&AbsoluteAddress::new(9, 6))),
            GameRoom::to_string2(position.piece_at(&AbsoluteAddress::new(8, 6))),
            GameRoom::to_string2(position.piece_at(&AbsoluteAddress::new(7, 6))),
            GameRoom::to_string2(position.piece_at(&AbsoluteAddress::new(6, 6))),
            GameRoom::to_string2(position.piece_at(&AbsoluteAddress::new(5, 6))),
            GameRoom::to_string2(position.piece_at(&AbsoluteAddress::new(4, 6))),
            GameRoom::to_string2(position.piece_at(&AbsoluteAddress::new(3, 6))),
            GameRoom::to_string2(position.piece_at(&AbsoluteAddress::new(2, 6))),
            GameRoom::to_string2(position.piece_at(&AbsoluteAddress::new(1, 6))),
            GameRoom::to_string2(position.piece_at(&AbsoluteAddress::new(9, 7))),
            GameRoom::to_string2(position.piece_at(&AbsoluteAddress::new(8, 7))),
            GameRoom::to_string2(position.piece_at(&AbsoluteAddress::new(7, 7))),
            GameRoom::to_string2(position.piece_at(&AbsoluteAddress::new(6, 7))),
            GameRoom::to_string2(position.piece_at(&AbsoluteAddress::new(5, 7))),
            GameRoom::to_string2(position.piece_at(&AbsoluteAddress::new(4, 7))),
            GameRoom::to_string2(position.piece_at(&AbsoluteAddress::new(3, 7))),
            GameRoom::to_string2(position.piece_at(&AbsoluteAddress::new(2, 7))),
            GameRoom::to_string2(position.piece_at(&AbsoluteAddress::new(1, 7))),
            GameRoom::to_string2(position.piece_at(&AbsoluteAddress::new(9, 8))),
            GameRoom::to_string2(position.piece_at(&AbsoluteAddress::new(8, 8))),
            GameRoom::to_string2(position.piece_at(&AbsoluteAddress::new(7, 8))),
            GameRoom::to_string2(position.piece_at(&AbsoluteAddress::new(6, 8))),
            GameRoom::to_string2(position.piece_at(&AbsoluteAddress::new(5, 8))),
            GameRoom::to_string2(position.piece_at(&AbsoluteAddress::new(4, 8))),
            GameRoom::to_string2(position.piece_at(&AbsoluteAddress::new(3, 8))),
            GameRoom::to_string2(position.piece_at(&AbsoluteAddress::new(2, 8))),
            GameRoom::to_string2(position.piece_at(&AbsoluteAddress::new(1, 8))),
            GameRoom::to_string2(position.piece_at(&AbsoluteAddress::new(9, 9))),
            GameRoom::to_string2(position.piece_at(&AbsoluteAddress::new(8, 9))),
            GameRoom::to_string2(position.piece_at(&AbsoluteAddress::new(7, 9))),
            GameRoom::to_string2(position.piece_at(&AbsoluteAddress::new(6, 9))),
            GameRoom::to_string2(position.piece_at(&AbsoluteAddress::new(5, 9))),
            GameRoom::to_string2(position.piece_at(&AbsoluteAddress::new(4, 9))),
            GameRoom::to_string2(position.piece_at(&AbsoluteAddress::new(3, 9))),
            GameRoom::to_string2(position.piece_at(&AbsoluteAddress::new(2, 9))),
            GameRoom::to_string2(position.piece_at(&AbsoluteAddress::new(1, 9))),
            //                   ▲き,　                   ▲ぞ,                     ▲い,                     ▲ね,                     ▲う,                     ▲し,                     ▲ひ,
